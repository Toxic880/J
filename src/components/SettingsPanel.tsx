...
// Phase 11: Microphone quality and audio settings
import { MicrophoneQualityPanel, AudioSettingsPanel } from './MicrophoneQualityPanel';
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeSection === 'voice' && (
            <div className="space-y-6">
              ...
              {/* Phase 11: Microphone Quality */}
              <SubsectionTitle>Microphone Quality</SubsectionTitle>
              <InfoBox>
                Test your microphone quality to ensure JARVIS can hear you clearly.
                Poor microphone quality can cause missed wake words and incorrect transcription.
              </InfoBox>
              <MicrophoneQualityPanel compact showRecommendations />

              <Divider />

              {/* Phase 11: Audio Processing Settings */}
              <SubsectionTitle>Audio Processing</SubsectionTitle>
              <AudioSettingsPanel />
            </div>
          )}
          ...
          {activeSection === 'advanced' && (
            <div className="space-y-6">
              ...
              {/* Phase 12: Power Mode */}
              <SubsectionTitle>Power Management</SubsectionTitle>
              <SelectField
                label="Power Mode"
                value={prefs.powerMode || 'auto'}
                onChange={(v) => updatePref('powerMode', v as any)}
                options={[
                  { value: 'auto', label: 'Automatic (Recommended)' },
                  { value: 'efficiency', label: 'Efficiency (Save Power)' },
                  { value: 'performance', label: 'Performance (Always Ready)' },
                ]}
              />
              <InfoBox>
                <strong>Automatic:</strong> JARVIS manages power automatically - sleeps when idle, wakes instantly when needed.
                <br /><br />
                <strong>Efficiency:</strong> Aggressively saves power. Best for laptops and background use.
                <br /><br />
                <strong>Performance:</strong> Keeps the full model loaded. Faster responses but uses more power.
              </InfoBox>
